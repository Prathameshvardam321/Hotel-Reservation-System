...
public class HotelList {
   ...
   void setDataForLakewood(int weekday,int weekend){
       Hotel lakeWood = new Hotel();
       lakeWood.setName("LakeWood");

       lakeWood.setWeekDayRateForRegularCustomer(weekday);
       lakeWood.setWeekendRatesForRegularCustomer(weekend);
       hotels.add(lakeWood);
   }
   void setDataBridgeWood(int weekday,int weekend){
       Hotel bridgeWood = new Hotel();
       bridgeWood.setName("BridgeWood");
       bridgeWood.setRating(5);
       bridgeWood.setWeekDayRateForRegularCustomer(weekday);
       bridgeWood.setWeekendRatesForRegularCustomer(weekend);
       bridgeWood.setRating(3);
       hotels.add(bridgeWood);
   }
   void setDataRidgewood(int weekday,int weekend){
       Hotel ridgeWood = new Hotel();
       ridgeWood.setName("RidgeWood");
       ridgeWood.setRating(4);
       ridgeWood.setWeekendRatesForRegularCustomer(weekend);
       ridgeWood.setWeekDayRateForRegularCustomer(weekday);
       hotels.add(ridgeWood);
   }
   void print(){
        for (Hotel h : hotels){
